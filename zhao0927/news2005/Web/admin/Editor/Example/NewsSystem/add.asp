...
Sub Content()
	...
	<tr>
		...
		<td>
			...
			<iframe ID="eWebEditor1"  frameborder="0" scrolling="no" width="550" HEIGHT="350">
                 <ce:editor id="ce1" runat="server" FilesPath="~\CuteSoft_Client\CuteEditor" Height="800px"></ce:editor>
